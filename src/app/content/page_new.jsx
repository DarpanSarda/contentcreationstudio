...
export default function ContentLibraryPage() {
  ...
  const ContentCard = ({ item }) => (
    <div className="glass rounded-xl border border-white/10 overflow-hidden hover:border-accent-cyan/50 transition-all group">
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-text-muted">{item.content_type || 'article'}</span>
          </div>
