  ...
  return (
    <div className="min-h-screen flex items-start justify-center bg-dark-bg px-4 pt-32 lg:pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 right-20 w-96 h-96 bg-accent-orange/5 rounded-full blur-3xl" />
        ...
        <div className="glass rounded-2xl p-8 border border-white/10">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  onChange={handleChange}
                  className="w-4 h-4 bg-card-bg/20 border-white/20 rounded focus:ring-2 focus:ring-accent-cyan text-accent-cyan"
                  disabled={isLoading}
                />
                <label htmlFor="remember" className="ml-2 text-sm text-text-light">
                  Remember me
                </label>
              </div>
              <Link
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              disabled={isLoading}
              className="flex items-center justify-center gap-2 py-2.5 px-4 border border-white/20 rounded-lg hover:border-accent-cyan/50 hover:text-accent-cyan transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
